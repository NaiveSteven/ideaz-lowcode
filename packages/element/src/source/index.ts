...
import { normalTemplate, TableProTemplate } from '../template';
import { TableProTemplateComponent } from './TablePro';
...
export const DEFAULT_COMPONENT_TEMPLATES: ExpandTemplateItem[] = [
  ...
  {
    collapseTitle: '高阶组件',
    components: [TableProTemplateComponent()],
  },
  {
    collapseTitle: '组件模板',
    components: [normalTemplate, TableProTemplate()],
  },
];
