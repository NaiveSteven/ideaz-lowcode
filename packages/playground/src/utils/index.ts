...
export function delJsonSchemaItem(schemas: any, id: string) {
...
export function replaceSchemaItem(schemas: any, id: string, toSchema: Schema) {
  const flat = (schema: any, curId: string) => {
    Object.keys(schema.properties || {}).forEach((key) => {
      if (schema.properties[key].id === curId) {
...
export function getSchemaItem(schemas: any, id: string) {
...
export function getTreeDataItem(list: any, id: string) {
  let obj: any = {}
...
export function changeDataId(list: any) {
